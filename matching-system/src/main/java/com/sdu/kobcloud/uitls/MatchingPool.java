...
public class MatchingPool extends Thread{
    ...
    private static final String startGameCallbackUrl = "http://127.0.0.1:3000/match/startGame/";
    ...
    private void sendMatchResult(Player a, Player b) {
        ...
        restTemplate.postForObject(startGameCallbackUrl, callbackData, String.class);
    }
